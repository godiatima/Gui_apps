...
class ComboBoxWindow(Gtk.Window):
	...
	def __init__(self):
		Gtk.Window.__init__(self, title="Combo Example")
		...
		name_store.append([2, "Bob McRoberts"])
		name_store.append([31, "Xavier McRoberts"])
		name_store.append([3, "Joey Jojo"])
		...
		countries = ["Austria", "Brazil", "Belgium", "France", "Germany", "Switzerland", "United Kingdom", "United State of america", "Uruguay"]
